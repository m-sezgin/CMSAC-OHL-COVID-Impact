...
ohl_age <- ohl_treatment %>%
  ...
  mutate(age = trunc((dob %--% as.Date("2022-01-01")) / years(1)),
         age_continuous = (dob %--% as.Date("2022-01-01")) / years(1)
  ) %>%
  ungroup()
...
ohl_filtered <- ohl_filtered %>%
  select(season, player_id, championship, gp_19_20, first_name, last_name, position, age, gp_19_20, pts_19_20, ppg_19_20, drafted, draft_year, round, overall_pick_num, age_continuous, pm_relative_19_20, pm_rank_19_20, pm_19_20, treatment, ppg_21_22, gp_covid, gp_21_22)
```
