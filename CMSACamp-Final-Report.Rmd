...
We decided to fit a variety of linear models in an attempt to capture the significance of playing during COVID, hoping that using several models would give us a stronger consensus. Initially, 
...
Variables found to be significant at the \(\alpha = .05\) level:
