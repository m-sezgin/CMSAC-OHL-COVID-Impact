...
Before performing causal analysis, we wanted to determine whether playing during the COVID season had a significant effect on PPG when controlling for variables (and interactions between variables) found to be associated with the response through EDA. Because PPG is right skewed and bounded between 0 and some positive number, we know the assumptions of  We To model the relationship 
